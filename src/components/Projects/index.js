...
const PROJECTS = [
  {
    ...
    live: 'https://krishnaebank.ccbp.tech/ebank/login',
    github: 'https://github.com/Krish1013/EBank_frontend',
    tag: 'Frontend',
  },
  {
    id: 2,
    ...
    live: 'https://krishnatasks.ccbp.tech/',
    github: 'https://github.com/Krish1013/My-Tasks',
    tag: 'Frontend',
  },
  {
    id: 3,
    ...
    live: 'https://rkpprscrgame.ccbp.tech/',
    github: 'https://github.com/Krish1013/Rock-Paper-Scissors',
    tag: 'Frontend',
  },
  {
    id: 4,
    ...
    live: 'https://instaclone13.ccbp.tech/login',
    github: 'https://github.com/Krish1013/Insta-Share-Instagram-Clone-',
    tag: 'Full Stack',
  },
  {
    id: 5,
    ...
    description:
      'A full-featured backend REST API for a Twitter-like social platform built using Node.js, Express, and SQLite. Implements comprehensive authentication, user relationships, tweet management, and secure data access with relational database queries.',
    tech: ['Node.js', 'Express.js', 'SQLite', 'JWT (jsonwebtoken)', 'bcrypt'],
    live: null,
    github: 'https://github.com/Krish1013/TwitterClone',
    tag: 'Backend',
    type: 'backend',
    features: [
      ...
      'Feed API (latest tweets from followed users)',
      'Likes & Replies system',
      'Secure access control (user-specific data protection)',
      ...
      <div className="container">
        ...
        <div className="projects-grid">
          {filtered.map((project, i) => (
            <div 
              className={`project-card ${project.type === 'backend' ? 'backend-card' : ''} reveal reveal-delay-${(i % 3) + 1}`} 
              key={project.id}
            >
              <div className="project-card-top">
                <span className={`project-tag ${project.type === 'backend' ? 'backend-tag' : ''}`}>
                  {project.tag}
                </span>
              ...
              {project.endpoints && project.endpoints.length > 0 && (
                <div className="project-endpoints">
                  <p className="endpoints-label">Core APIs:</p>
                  <div className="endpoints-grid">
                    {project.endpoints.map((endpoint, idx) => (
                      <span className="endpoint-pill" key={idx}>{endpoint}</span>
                    ))}
                  </div>
                </div>
              )}
